...
bezie((width//2,height//10), (width//2,height//3), (width//4,height//4), (width//4,height//2))
bezie((width//2,height//10), (width//2,height//3), (width*3//4,height//4), (width*3//4,height//2))
bezie((width//4,height//2), (width//4,height), (width*3//4,height), (width*3//4,height//2))
#image.show()
image.save("4.jpg")
del draw
