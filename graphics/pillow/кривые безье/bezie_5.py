...
bezie((width//3,height//4), (width//3,0), (width*2//3,0), (width*2//3,height//4))
bezie((width//3,height//4), (width//3,height//2), (width//2,height//2), (width*5//9,height*2//5))
bezie((width*5//9,height*2//5), (width*30//54,height*7//15), (width//2,height*11//15), (width*4//9,height*4//5))
bezie((width*4//9,height*4//5), (width*2//3,height*8//15), (width*2//3,height//2), (width*2//3,height//4))
#image.show()
image.save("5.jpg")
del draw
