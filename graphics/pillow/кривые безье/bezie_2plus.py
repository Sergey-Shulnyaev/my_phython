...
bezie((width//2,height//4), (width//2,height//3),
      (width//3,height//4), (width//3,height//3))
bezie((width//3,height//3), (width//3,height//2),
      (width//2,height//2), (width//2,height*2//3))
bezie((width//2,height//4), (width//2,height//3),
      (width*2//3,height//4), (width*2//3,height//3))
bezie((width*2//3,height//3), (width*2//3,height//2),
      (width//2,height//2), (width//2,height*2//3))
#image.show()
image.save("2+.jpg")
del draw
